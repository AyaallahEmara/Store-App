...
class JeweliryScreen extends StatelessWidget {
  const JeweliryScreen({Key? key}) : super(key: key);
  static String id = 'JeweliryScreen';
  @override
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: FutureBuilder<List<ProductModel>>(
          future: GetAllProductsByCategoryName().getAllProducts(categoryName: 'jewelery'),
